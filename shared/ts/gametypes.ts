...
Types.getKindFromString = function(kind: string) {
  if (kind in kinds) {
    return kinds[kind][0];
  }
};
Types.getKindAsString = function(kind: any) {
  for (let k in kinds) {
    if (kinds[k][0] === kind) {
      return k;
    }
...
Types.forEachKind = function(cb: (arg0: any, arg1: string) => void) {
  for (let k in kinds) {
    cb(kinds[k][0], k);
  }
};
Types.forEachArmor = function(cb: (arg0: any, arg1: any) => void) {
...
Types.forEachMobOrNPCKind = function(cb: (arg0: any, arg1: any) => void) {
  Types.forEachKind(function(kind: any, kindName: any) {
...
Types.forEachArmorKind = function(cb: (arg0: any, arg1: any) => void) {
  Types.forEachKind(function(kind: any, kindName: any) {
    if (Types.isArmor(kind)) {
      cb(kind, kindName);
    }
...
Types.forEachWeaponKind = function(cb: (arg0: any, arg1: any) => void) {
  Types.forEachKind(function(kind: any, kindName: any) {
...
Types.getOrientationAsString = function(orientation: any) {
  switch (orientation) {
...
Types.getRandomItemKind = function(item: any, _?: any) {
  let all = _.union(Types.rankedWeapons, Types.rankedArmors),
...
Types.getMessageTypeAsString = function(type: any, _?: any) {
  let typeName: any;
